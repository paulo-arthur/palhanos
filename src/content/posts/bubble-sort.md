---
title: Bubble Sort
subtitle: Algoritmo de ordenação que lembra bolhas em busca da superfície.
...
conjunto verificando, em cada iteração, se o próximo elemento é menor que o anterior. Se for, executa a troca. O algoritmo percore o *array* até não realizar ne
...
(Clique para visualizar) - Fonte: Wikipédia
